...
const (
	...
	AuthService_RefreshTokens_FullMethodName = "/api.AuthService/RefreshTokens"
)
...
type AuthServiceClient interface {
	...
	RefreshTokens(ctx context.Context, in *RefreshToken, opts ...grpc.CallOption) (*AuthResponse, error)
}
...
func (c *authServiceClient) RefreshTokens(ctx context.Context, in *RefreshToken, opts ...grpc.CallOption) (*AuthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthResponse)
...
type AuthServiceServer interface {
	...
	RefreshTokens(context.Context, *RefreshToken) (*AuthResponse, error)
...
func (UnimplementedAuthServiceServer) RefreshTokens(context.Context, *RefreshToken) (*AuthResponse, error) {
...
func _AuthService_RefreshTokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).RefreshTokens(ctx, req.(*RefreshToken))
	}
	return interceptor(ctx, in, info, handler)
}
